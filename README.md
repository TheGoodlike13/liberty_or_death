...
Do keep in mind, you have to choose whether you go with "apply plugin" or "plugin in"
...
Now I had a project that wasn't exploding. I start following [#how_to_deploy].
Immediately none of the classes they use in their example are present.
Thankfully, [#mr_baeldung] comes to the rescue!
...
Yeah, like I remember how to do that! I decided to go with [#ibm_gradle] next.
...
I turned to the plugin documentation next, finding [#gradle_plugin_deeper].
...
[#gradle_plugin_deeper] suggests the property is not needed when using 'war' plugin.
